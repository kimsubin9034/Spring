package com.condingbox.core3.basic.request.controller;
...
import com.condingbox.core3.basic.HelloData;
...
public class RequestParamController {
		 ...
		 * -String, int와 같은 단순 타입 = @RequestParam 생략
		 * -객체로 파라미터가 넘어왔을때 생략 = @ModelAttribute 생략
		 * 
		 */
		@ResponseBody
		@RequestMapping("/request-attribute-v3")
		public String requestAttributeV3(@ModelAttribute HelloData helloData)
		{
			System.out.println("username:" + helloData.getUsername());
			System.out.println("age:" + helloData.getAge());
			System.out.println("helloData : " + helloData.toString());
